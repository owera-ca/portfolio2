...
const Footer = () => {
    return (
        <footer className="bg-dark text-gray-400 pt-20 pb-10 border-t border-white/5 font-sans">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-4xl font-bold mb-6 tracking-tighter text-white">
                            OWERA<span className="text-primary">.</span>
                        </h3>
                        <p className="mb-6 leading-relaxed max-w-sm font-light text-lg">
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start space-x-4 group cursor-pointer">
                                <div className="p-2 bg-white/5 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300">
                                    <Mail size={20} />
                                </div>
                                <div>
                                    <p className="text-xs uppercase tracking-wide text-gray-500 mb-1">Email Us</p>
